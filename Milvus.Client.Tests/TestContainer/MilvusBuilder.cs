...
{
    public const string DefaultImageTag = "v2.2.16";
    // public const string DefaultImageTag = "v2.3.0";

    public const string MilvusImage = "milvusdb/milvus";
    ...
    protected override MilvusBuilder Init()
    {
        ...
        string fullImage = MilvusImage + ":" +
                           (Environment.GetEnvironmentVariable("MILVUS_IMAGE_TAG") ?? DefaultImageTag);

        // milvusdb/milvus:v2.2.16
        return base.Init()
            .WithImage(fullImage)
        ...
        // .UntilPortIsAvailable(MilvusGrpcPort));
